...
[openrouteservice](https://go.openrouteservice.org) (ORS) API from R. 
...
For further details, please visit:
  ...
  - [ORS API documentation](https://go.openrouteservice.org/documentation/)
  - [openrouteservice-r documentation](http://GIScience.github.io/openrouteservice-r/)
...
`ors_directions` interfacces the ORS directions service to compute routes between given `coordinates`. 
